            ...
            <div class="row clearfix">
                ...
                <div class="images-column col-lg-7 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="image">
                            <img src="{{ asset('assets/images/resource/benefit-1.jpg') }}" alt="" />
                        </div>
                        <div class="image-two">
                            <img src="{{ asset('assets/images/resource/benefit-3.jpg') }}" alt="" />
                        </div>
                        <div class="image-three">
                            <img src="{{ asset('assets/images/resource/benefit-2.jpg') }}" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div class="image-column col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="feature-icon wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <img src="{{ asset('assets/images/resource/feature-icon.png') }}" alt="" />
                        </div>
                    </div>
                </div>
