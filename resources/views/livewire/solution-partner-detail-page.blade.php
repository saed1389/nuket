    ...
    <section class="blog-detail-banner-section">
        ...
        <div class="auto-container">
            <ul class="page-breadcrumb">
                ...
                <li><a href="/solution-partner-page">{{ __('homePage.Solution partners') }}</a></li>
                <li>{{ $solution->title }} </li>
            </ul>
            <div class="content-box">
                <h2>{{ $solution->title }}  <a href=""><img src="{{ asset('assets/images/log.png') }}" alt="" style="width: 50px;"></a></h2>
                <div class="clearfix">
                    <div class="pull-left">
                        ...
                        <div class="inner-box">
                            <div class="image-column col-lg-6 col-md-6 col-sm-12 ">
                                <div class="inner-column">
                                    <div class="image">
                                        <img class="rounded" src="{{ asset( $solution->image) }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="inner-box mt-5">
                                <p>
                                    @if($lang == 'tr') {!! $solution->description !!} @else {!! $solution->{'description_'. $lang} !!} @endif
                                </p>
                            </div>
                        </div>
                    </div>
